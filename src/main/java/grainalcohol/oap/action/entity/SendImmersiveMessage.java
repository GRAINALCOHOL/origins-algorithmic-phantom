...
//            .add("rainbow", SerializableDataTypes.FLOAT, 2.0F)
    ...
    public void accept(SerializableData.Instance data, Entity entity) {
        if (entity instanceof ServerPlayerEntity serverPlayer){
            ...
            TextAnchor align = MiscUtil.tryGetAnchorFromString(data.getString("align"));
            TextAnchor anchor = MiscUtil.tryGetAnchorFromString(data.getString("anchor"));
            TextAnchor subtitle_align = MiscUtil.tryGetAnchorFromString(data.getString("subtitle_align"));
            TextAnchor subtitle_anchor = MiscUtil.tryGetAnchorFromString(data.getString("subtitle_anchor"));
...
//            }
            ...
            MiscUtil.sendToPlayer(message, serverPlayer, true);
        }
    }
}
